      ...
      <div className="max-w-3xl mx-auto p-6 rounded">
        ...
        <section className="mb-4">
          ...
          <p className="text-base">
            We are Waseem Akram (&quot;Company,&quot; &quot;we,&quot; &quot;us,&quot; &quot;our&quot;), a company registered in Pakistan.
          </p>
        </section>
        <section className="mb-4">
          <p className="text-base">
            We operate the website https://hackerwasii.com (the &quot;Site&quot;), as well as any other related products and services that refer or link to these legal terms (the &quot;Legal Terms&quot;) (collectively, the &quot;Services&quot;).
          </p>
        </section>
        <section className="mb-4">
          <p className="text-base">
            You can contact us by email at hello@hackerwasii.com
          </p>
        </section>
        <section className="mb-4">
          <p className="text-base">
            These Legal Terms constitute a legally binding agreement made between you, whether personally or on behalf of an entity (&quot;you&quot;), and Waseem Akram, concerning your access to and use of the Services. You agree that by accessing the Services, you have read, understood, and agreed to be bound by all of these Legal Terms. IF YOU DO NOT AGREE WITH ALL OF THESE LEGAL TERMS, THEN YOU ARE EXPRESSLY PROHIBITED FROM USING THE SERVICES AND YOU MUST DISCONTINUE USE IMMEDIATELY.
          </p>
        </section>
        <section className="mb-4">
          <p className="text-base">
            We will provide you with prior notice of any scheduled changes to the Services you are using. The modified Legal Terms will become effective upon posting or notifying you by hello@hackerwasii.com, as stated in the email message. By continuing to use the Services after the effective date of any changes, you agree to be bound by the modified terms.
            <br />
            <br />
        ...
        <section className="mb-4">
          <h2 className="text-2xl font-semibold mb-2">3. USER REPRESENTATIONS</h2>
          <p className="text-base">
        ...
        <section className="mb-4">
          <h2 className="text-2xl font-semibold mb-2">4. USER REGISTRATION</h2>
          <p className="text-base">
            You may be required to register to use the Services. You agree to keep your password confidential and will be responsible for all use of your account and password. We reserve the right to remove, reclaim, or change a username you select if we determine, in our sole discretion, that such username is inappropriate, obscene, or otherwise objectionable.
          </p>
        </section>
        <section className="mb-4">
          <h2 className="text-2xl font-semibold mb-2">5. PURCHASES AND PAYMENT</h2>
          <p className="text-base">
