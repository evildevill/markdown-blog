    ...
    async redirects() {
        return [
          ...
          },
          {
            ...
            destination: '/blogposts/malware-development-how-to-call-windows-api-from-go',
            permanent: true, // This indicates a 301 permanent redirect
          },
          {
            source: '/posts/malware-development-create-remote-thread-shellcode-injection-golang',
            destination: '/blogposts/malware-development-create-remote-thread-shellcode-injection-golang',
            permanent: true, // This indicates a 301 permanent redirect
          },
          {
